...
func ExampleShortLong_LongURLFromShort() {
	...
	// Подготовка запроса
	// Значение EwHXdJfB, может быть другим и должно быть заранее известным.
	path := "/EwHXdJfB"
...
func ExampleShortLong_DeleteUserURLs() {
	...
	req.Header.Set("Authorization", "oups")
	...
	// При оспешной обработке запроса, возвращается http.StatusAccepted (202)
